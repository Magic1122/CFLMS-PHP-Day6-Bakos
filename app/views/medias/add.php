...
<div class="card card-body bg-light mt-5">
    <h2>Add Medium</h2>
    <p>Create a medium with this form</p>
    <form action="<?php echo URLROOT;?>/medias/add" method="POST">
        ...
        <div class="form-group">
            ...
            class="form-control form-control-lg <?php echo (!empty($data['author_err'])) ? 'is-invalid' : ''; ?>">
                ...
                ?>
                <script type="text/javascript">
                document.getElementById('author').value = "<?php echo $_POST['author'];?>";
            </script>
                </select>
            <span class="invalid-feedback"><?php echo $data['author_err']; ?></span>
            <a href="<?php echo URLROOT;?>/medias/addauthor/0" class="btn btn-success mt-3">Add Author</a>
        </div>
        <div class="form-group">
            ...
            class="form-control form-control-lg <?php echo (!empty($data['publisher_err'])) ? 'is-invalid' : ''; ?>">
                ...
                <script type="text/javascript">
                document.getElementById('publisher').value = "<?php echo $_POST['publisher'];?>";
            </script>
            <span class="invalid-feedback"><?php echo $data['publisher_err']; ?></span>
            <a href="<?php echo URLROOT;?>/medias/addpublisher/0" class="btn btn-success mt-3">Add Publisher</a>
        </div>
